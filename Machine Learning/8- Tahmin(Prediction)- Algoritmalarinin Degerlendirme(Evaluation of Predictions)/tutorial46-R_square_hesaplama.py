...
# Decision tree yalnizca tablodan verilen degerleri dondurur, herhenagi bir ara deger tahmini yapmaz
...
# n_estimators -> Decision Tree sayisi
...
# bu degerleri farkli gorur ve yeni tahmin degerleri uretir boylelikle decison t. ye gore sahada daha basarilidir  
 ...
 # ders : 46
 # R-Squre hesaplanmasi
 # R-Square -> Herhangi bir tahmin algoritmasinin, orjinal veri ve tahmin edilen bilgilerini kullanarak predict algrorithms basarisini verir
 # yi -> i. actual data , y_pre -> tahmin edilen i. veri, y_ave -> tum actual data'larin ortalamasi
 # sum(yi-y_pre)^2 -> Hata karelerinin toplami
 # sum(yi-y_ave)^2 -> Ortalama Farklarinin Toplami
 # R^2 = 1 - (HKT / OFT)
...
# R2 degerine gore decision tree nin en iyi tahmin alg oldugu goruluyor ancak bu yargi hatalidir!!
# Decision Tree ara deger tahmin etmeden, en yakin data point sectiginden dolayi kucuk farklilastirmalari
# farkedemez ve bize surekli ayni degeri dondurur.Yani bizim verdigimiz actual data 'lara karsilik genellikle actual data tahmini yapar
# bu durum bizim R-square degerimizi max yani 1 dondurmesine sebep olur
